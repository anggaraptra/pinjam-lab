...
$peminjam = query("SELECT * FROM peminjaman WHERE nama_lab = 'dkv'");
...
<head>
    ...
    <title>Pinjam Lab &mdash; DKV</title>
</head>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item aktif" href="">Lab DKV</a></li>
    ...
    <section id="jadwal">
        <div class="container-fluid">
            <div class="row p-2 mt-2 mb-3">
                <div class="col">
                    <h2 class="fw-normal">Jadwal Lab DKV</h2>
                </div>
            </div>
