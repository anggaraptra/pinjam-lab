...
$peminjam = query("SELECT * FROM peminjaman WHERE nama_lab = 'tkj'");
...
<head>
    ...
    <title>Pinjam Lab &mdash; TKJ</title>
</head>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item aktif" href="">Lab TKJ</a></li>
                            <li><a class="dropdown-item" href="mm.php">Lab MM</a></li>
                            <li><a class="dropdown-item" href="dkv.php">Lab DKV</a></li>
                            <li><a class="dropdown-item" href="animasi.php">Lab Animasi</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
    ...
    <section id="jadwal">
        <div class="container-fluid">
            <div class="row p-2 mt-2 mb-3">
                <div class="col">
                    <h2 class="fw-normal">Jadwal Lab TKJ</h2>
                </div>
            </div>
