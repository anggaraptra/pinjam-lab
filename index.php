...
$peminjam = query("SELECT * FROM peminjaman");
...
<head>
    ...
    <title>Pinjam Lab &mdash; Home</title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold" href="#"><span>PINJAM</span>LAB</a>
    ...
    <!-- jumbotron -->
    <section id="jumbotron" class="p-2">
        <div class="container-fluid rounded p-5">
            <div class="row text-center">
                <div class="col-lg-6 mb-4 teks">
                    <h3>PEMINJAMAN LAB
                        <br>DENGAN MUDAH
                    </h3>
                </div>
                <div class="col-lg-6  d-none d-lg-block">
                    <img src="assets/img/lab.png" width="300px" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="jadwal">
        <div class="container-fluid">
            <div class="row p-2 text-center mt-2 mb-3">
                <div class="col">
                    <h2 class="fw-normal">Jadwal Peminjam</h2>
                </div>
            </div>
                                        ...
                                        <?php foreach ($peminjam as $pnjm) : ?>
                                            <?php if ($pnjm['waktu_pinjam'] == '08:00-09:00') : ?>
                                                <div class="schedule mb-1">
                                                    <p class="mt-2"><span class="fw-bold">Lab <span class="text-capitalize"><?= $pnjm['nama_lab'] ?></span></span>
                                                        <br>Dipinjam oleh <span class="fw-bold"><?= $pnjm['nama_peminjam']; ?></span>
                                                    </p>
                                                </div>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                    ...
                                    <td>
                                        <?php foreach ($peminjam as $pnjm) : ?>
                                            <?php if ($pnjm['waktu_pinjam'] == '09:00-10:00') : ?>
                                                <div class="schedule mb-1">
                                                    <p class="mt-2"><span class="fw-bold">Lab <span class="text-capitalize"><?= $pnjm['nama_lab'] ?></span></span>
                                                        <br>Dipinjam oleh <span class="fw-bold text-capitalize"><?= $pnjm['nama_peminjam']; ?></span>
                                                    </p>
                                                </div>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
